...
#ldf = dataloader('../training/Narrowfeature_1.txt')
# ldf = dataloader('Narrowfeature_1.txt')
# ldf = dataloader('/data/whf/AI/training/PALFA_FAST_Resnet_180725.txt')
ldf = dataloader('PALFAtraining_180606.txt')
# ldf = dataloader('PALFAtraining.txt')
print "Running"
#for p in ldf.pfds:
    #p.extracted_feature = {}
...
#ldf.cross_val_score(resnet, verbose=True)


""" join the layer-1 classifiers into a combined-AI """
AIs = [nn1, nn2, nn3, nn4, nn5, clf1, clf2, clf3, clf4,  clf5, tree3, lg1, lg2, resnet_sub, resnet_int]
#AIs = [nn1, nn2, nn3, nn4, nn5, clf1, clf2, clf3, clf4,  clf5, tree3, lg1, lg2, resnet]
#good combos discovered so far:
#combo = [13] #F1 = 0.9
# combo = [0, 4, 5, 8, 13, 14]
# combo = [5, 6, 7, 8, 13, 14]
combo = [5, 8, 13, 14]
# combo = [0, 4, 5, 6, 7, 8, 13, 14] #F1 = 0.9
#combo = [0, 1, 3, 4, 5, 6, 7, 8, 13, 14] #F1 = 0.9
...
cPickle.dump(clfl2, open(AI_PATH + "/trained_AI/resnet_adm_residual_num_3.pkl", 'wb'), protocol=2)
